...
function GlobalBrandContent() {
  return (
    <div className='p-[70px] flex flex-col justify-between max-[1370px]:p-[50px]  max-[1350px]:py-[40px] max-[1150px]:p-[20px] max-[1160px]:py-[15px] max-[900px]:pr-2 max-[590px]:gap-10 max-[590px]:p-[50px] max-[500px]:p-[40px] max-[400px]:p-[30px] max-[370px]:pl-[20px]'>
        {/* content div */}
        <div className='flex flex-col gap-6 max-[445px]:gap-4 max-[291px]:gap-3'>
        
            <h1  className=' text-3xl  w-[536px] max-[1260px]:text-2xl max-[1260px]:w-[500px] max-[1000px]:w-[430px] max-[900px]:w-[400px] max-[800px]:w-[350px] max-[760px]:w-[300px] max-[660px]:w-[270px] max-[590px]:w-[450px] max-[500px]:w-[380px] max-[445px]:w-[330px] max-[400px]:w-[290px] max-[315px]:w-[240px]  max-[300px]:w-[225px]  '>From a studio in London to a global brand with
            over 400 outlets</h1>
